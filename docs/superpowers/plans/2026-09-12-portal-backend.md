...
5. **Handoff:** commit evidence and exact route/event examples in `docs/backend`; record frontend adapter/browser integration as a separate dependency-tracked ticket for the portal owner. Do not claim fixture screenshots prove live integration. Leave existing legacy acceptance policies intact.
