...
| T1 · Tickets and claims | In progress | tickets-1 | Let agents create and assign tasks, reserve work, report progress, and hand it to you for review. Recover abandoned tasks safely. | — |
...
| T3 · Work skill and setup | Review fixes | setup-1 | Teach Codex and Claude Code when and how to use Conductor through a simple installation that preserves existing settings. | — |
