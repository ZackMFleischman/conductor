...
| T8 · CON-5 · Prepared tickets and validation | Built; review fixes underway | workflow-tickets-1 | Let agents plan and review tickets before coding, respect dependencies, and use automated, independent-agent, or human validation as configured. | — |
| T9 · CON-6 · Managed agent team | Built; review fixes underway | workflow-team-1 | Track which agents were launched, confirm they are ready, recover interrupted coordination, and limit concurrency to available capacity. | — |
| T10 · CON-7 · Workflow improvement | Built; integration underway | workflow-retro-1 | Turn problem reports into deduplicated improvement tickets, defer work to milestones, and record whether fixes helped. | T8 for linked draft tickets |

| T11 · Layer separation | In progress | layer-foundation-1 / layer-team-1 | Let agents use ordinary tickets, dependencies and result review without requiring our planning workflow or orchestrator. Preserve existing data and optional gates. | Foundation migration, then policy integration |
| T12 · CON-8 · Portal | Ready for another agent | portal-coordinator-1 | Build a React and MUI Kanban board in its own worktree, then connect it through a documented API contract. | User starts portal agent; live integration follows contract |
